...
const Orders = () => {
  ...
  const viewOrder = async (orderId) => {
    try {
        ...
        console.error("Failed to fetch orders information", err);        
    }
  };
  ...
  return (
    <div className={styles.pageBackground}>
        <div className={styles.container}>
            <div className='mb-8'>
                <h1 className={styles.headerTitle}>Manage Orders</h1>
            ...
            <div className={styles.controlsContainer}>
              <div className={styles.controlsInner}>
                <div className={styles.tabsContainer}>
                  {tabs.map(tab => (
                    <button key={tab.id} className={styles.tabButton(activeTab === tab.id)}
              ...
              <div className='overflow-x-auto'>
                ...
                {!sortedOrders.length && (
                  <div className={styles.emptyState}>
                    ...
                    <h3 className={styles.emptyTitle}>There is No Order yet</h3>
                    <p className={styles.emptyMessage}>Try adjusting filter/search or Come back later</p>
                  </div>
                )}
          ...
          <div className={styles.modalOverlay}>
            <div className={styles.modalContainer}>
              ...
              <div className={styles.modalGrid}>
                ...
                <div className={styles.modalSection}>
                  <h3 className={styles.sectionTitle}>
                    <BookOpen className={styles.searchIcon} />
                    Order Summary
                  </h3>
                  <div className={styles.sectionContent}>
