...
export const navbarStyles = {
  ...
  logoGradient: "absolute -inset-3 rounded-full opacity-0 blur-xl group-hover:opacity-30 transition-opacity bg-linear-to-r from-[#A0522D] to-[#FDF6EC]",
  logoImage: "h-8 w-8 rounded-full z-10",
  logoText: "text-xl font-bold bg-linear-to-r from-[#6B3A2A] to-[#A0522D] bg-clip-text text-transparent",
  logoUnderline: "h-0.5 w-0 bg-linear-to-r from-[#A0522D] to-[#D4A574] group-hover:w-full transition-all duration-500",
  ...
  cartGradient: "absolute -inset-2 bg-linear-to-r from-[#A0522D] to-[#6B3A2A] rounded-full opacity-0 blur-md group-hover:opacity-30 transition-opacity duration-500",
  cartIcon: "relative h-5 w-5 text-gray-600 group-hover:text-[#A0522D] transition-colors duration-300 z-10",
  cartBadge:
    "absolute top-[-14px] right-[-14px] flex items-center justify-center w-5 h-5 bg-linear-to-r from-[#A0522D] to-[#6B3A2A] text-[10px] font-bold text-white rounded-full",

  loginWrapper: "relative group",
  loginGradient: "absolute -inset-2 bg-linear-to-r from-[#C8956C] to-[#A0522D] rounded-full opacity-0 blur-md group-hover:opacity-30 transition-opacity duration-500",
  loginIcon: "relative h-5 w-5 text-gray-600 group-hover:text-[#A0522D] transition-colors duration-300 z-10",

  menuBtn: "relative group p-1",
  menuGradient: "absolute -inset-2 bg-linear-to-r from-[#D4A574] to-[#A0522D] rounded-full opacity-0 blur-md group-hover:opacity-30 transition-opacity duration-500",
  ...
  mobileCartBadge:
    "absolute top-0 right-0 -mt-1 -mr-1 w-5 h-5 flex items-center justify-center text-[10px] font-bold text-white bg-linear-to-r from-[#A0522D] to-[#6B3A2A] rounded-full",
...
export const container =
  "min-h-screen flex items-center justify-center px-4 pt-20 md:pt-29 pb-12 relative bg-linear-to-br from-[#A0522D]/90 to-[#6B3A2A]/90";
...
export const wordClass =
  "absolute text-2xl sm:text-3xl font-medium text-transparent bg-clip-text bg-linear-to-r from-[#6B3A2A] to-[#A0522D] transition-all duration-500";
...
export const searchButton =
  "px-6 md:px-8 py-3 md:py-4 bg-linear-to-r from-[#6B3A2A] to-[#A0522D] text-white rounded-lg md:rounded-xl font-medium hover:shadow-lg transition-all duration-300 shadow-md flex items-center gap-2 justify-center hover:-translate-y-0.5 text-sm md:text-base";
...
export const statNumber = "text-xl md:text-2xl font-bold text-[#6B3A2A]";
...
export const imageWrapper =
  "relative w-full max-w-md lg:max-w-lg aspect-square bg-linear-to-br from-white/20 to-[#D4A574]/10 rounded-xl md:rounded-2xl overflow-hidden";
...
export const overlayEffect =
  "absolute inset-0 mix-blend-overlay bg-linear-to-t from-[#6B3A2A]/10 to-transparent";
...
export const ourBestSellersStyles = {
  section: "py-12 md:py-16 bg-[#FDF6EC]",
  ...
  gradientText: "bg-linear-to-r from-[#6B3A2A] to-[#A0522D] bg-clip-text text-transparent",
  ...
  qtyBtn: "text-[#6B3A2A] hover:text-[#A0522D] p-1 md:p-1.5",
  qtyText: "text-gray-900 font-medium w-6 text-center",

  addButton: "flex items-center gap-1.5 md:gap-2 px-4 md:px-6 py-2 md:py-3 bg-linear-to-r from-[#6B3A2A] to-[#A0522D] text-white rounded-lg md:rounded-xl font-medium hover:scale-[1.02] transition-transform text-sm md:text-base",
...
export const homeBooksStyles = {
  section: "py-20 bg-linear-to-br from-[#A0522D] to-[#D4A574] relative",
  container: "container mx-auto px-4 md:px-6",
  card: "bg-white rounded-2xl shadow-lg p-8 md:p-12",
  heading: "text-3xl md:text-4xl font-bold bg-linear-to-r from-[#6B3A2A] to-[#A0522D] bg-clip-text text-transparent mb-4",
  headingLine: "h-1 w-20 bg-linear-to-r from-[#A0522D] to-[#D4A574] rounded-full mx-auto",
  grid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8",
  bookCard: "group relative",
  imageWrapper: "relative h-72 overflow-hidden rounded-xl border-4 border-[#A0522D]/20 mb-4",
  ...
  discountPrice: "text-lg font-bold text-[#A0522D]",
  originalPrice: "text-gray-400 line-through",
  actualPrice: "text-lg font-bold text-[#A0522D]",
  qtyBox: "flex items-center justify-between bg-[#A0522D]/10 px-4 py-2 rounded-lg",
  qtyBtn: "text-[#A0522D] hover:text-[#6B3A2A] cursor-pointer",
  addBtn:
    "w-full flex items-center cursor-pointer justify-center gap-2 px-4 py-2 bg-linear-to-r from-[#6B3A2A] to-[#A0522D] text-white rounded-lg hover:shadow-lg transition-all",
  viewBtnWrapper: "flex justify-center mt-12",
  viewBtn:
    "group inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-[#A0522D] text-[#A0522D] hover:bg-[#A0522D]/10 transition-all",
...
export const homeAboutStyles = {
  ...
  bgBlur1: "absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-[#A0522D]/20 blur-[100px]",
  bgBlur2: "absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-[#D4A574]/20 blur-[100px]",
  ...
  imageGlow: "absolute -inset-4 bg-linear-to-r from-[#A0522D] to-[#D4A574] rounded-2xl blur opacity-0 group-hover:opacity-20 transition-opacity duration-500",
  imageContainer: "relative overflow-hidden rounded-xl border-4 border-[#A0522D]/20",
  aboutImage: "w-full h-auto rounded-xl transition-transform duration-700 hover:rotate-1",
  aboutHeader: "text-3xl md:text-4xl font-bold bg-linear-to-r from-[#6B3A2A] to-[#A0522D] bg-clip-text text-transparent mb-4",
  underline: "h-1 w-20 bg-linear-to-r from-[#A0522D] to-[#D4A574] rounded-full",
  aboutText: "text-gray-600 leading-relaxed",
  statGrid: "grid grid-cols-1 md:grid-cols-3 gap-6",
  statCard: "bg-white border-2 border-[#A0522D]/20 rounded-xl p-4 text-center shadow-lg",
  statIconWrap: "inline-flex items-center justify-center p-3 bg-[#FDF6EC] rounded-full mb-3",
  statIcon: "h-6 w-6 text-[#A0522D]",
  statValue: "text-2xl font-bold text-gray-900",
  statLabel: "text-sm text-gray-600",
  aboutButton: "group inline-flex items-center justify-center px-6 py-3 rounded-full bg-linear-to-r from-[#6B3A2A] to-[#A0522D] text-white font-medium shadow-sm hover:shadow-[#A0522D]/25 transition-all duration-300",
  arrowIcon: "ml-2 h-4 w-4 transition-transform group-hover:translate-x-1",
  sectionHeader: "text-3xl md:text-4xl font-bold bg-linear-to-r from-[#6B3A2A] to-[#A0522D] bg-clip-text text-transparent mb-4",
  headerUnderline: "h-1 w-20 mx-auto bg-linear-to-r from-[#A0522D] to-[#D4A574] rounded-full",
  ...
  bookCardGlow: "absolute -inset-0.5 bg-linear-to-r from-[#A0522D] to-[#D4A574] rounded-xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-500",
  bookCard: "relative bg-white border-2 border-[#A0522D]/20 rounded-xl overflow-hidden transition-all duration-500 hover:shadow-lg hover:shadow-[#A0522D]/20 h-full flex flex-col",
  ...
  bookAuthor: "text-sm text-[#A0522D] mb-3",
  bookDesc: "text-gray-600 text-sm mb-4 flex-grow",
  discoverLink: "inline-flex items-center text-[#A0522D] hover:text-[#6B3A2A] transition-colors",
...
export const footerStyles = {
  footer: "bg-[#FDF6EC] border-t border-[#A0522D]/20 pt-16 pb-8 relative",
  container: "container mx-auto px-4 md:px-6",
  ...
  logoText: "text-2xl font-bold bg-linear-to-r from-[#6B3A2A] to-[#A0522D] bg-clip-text text-transparent",
  aboutText: "text-gray-600 text-sm leading-relaxed",
  socialWrap: "flex gap-3",
  socialButton: "flex items-center justify-center w-9 h-9 rounded-full bg-white border border-[#A0522D]/30 hover:border-[#A0522D] hover:bg-[#D4A574]/20 transition-all duration-300",
  socialIcon: "h-4 w-4 text-[#A0522D] transition-colors duration-300",
  quickLinksBlock: "space-y-4",
  quickLinksTitle: "text-lg font-semibold text-gray-900 mb-2",
  quickLinksList: "space-y-2.5",
  quickLinkItem: "group inline-flex items-center text-gray-600 hover:text-[#A0522D] transition-colors duration-300 text-sm",
  quickLinkDot: "w-1.5 h-1.5 bg-[#A0522D] rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200",
  ...
  formWrap: "relative",
  input: "w-full px-4 py-2.5 bg-white border border-[#A0522D]/30 rounded-lg text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#A0522D]/50 transition-all pr-12",
  button: "absolute right-1 top-1 p-2 bg-linear-to-r from-[#6B3A2A] to-[#A0522D] rounded-md text-white hover:scale-105 transform transition-all shadow-sm hover:shadow-[#A0522D]/30",
  ...
  contactIcon: "h-4 w-4 text-[#A0522D] mr-2 mt-1 flex-shrink-0",
  contactRow: "flex items-center text-gray-600 text-sm",
  contactIconInline: "h-4 w-4 text-[#A0522D] mr-2 flex-shrink-0",
  copyrightWrap: "border-t border-[#A0522D]/20 pt-6 text-center",
...
const aboutStyles = {
  container: "min-h-screen bg-linear-to-br from-[#fff5f5] to-[#ffe4e4] pt-24",
  ...
  heading: "text-6xl md:text-7xl font-black bg-linear-to-r from-[#b91c1c] to-[#dc2626] bg-clip-text text-transparent mb-6 leading-tight",
  underline: "absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-48 h-2 bg-linear-to-r from-[#dc2626] to-[#fca5a5] rounded-full",
  subText: "text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium",

  statsSection: "py-20 bg-linear-to-br from-[#dc2626]/5 via-[#fca5a5]/5 to-[#dc2626]/5",
  statCard: "bg-white/95 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-[#dc2626]/10 transition-transform hover:-translate-y-2",
  statIconWrapper: "w-16 h-16 rounded-2xl bg-linear-to-r from-[#dc2626] to-[#fca5a5] flex items-center justify-center mb-6 shadow-lg",
  statValue: "text-5xl font-black text-[#b91c1c] mb-2",
  ...
  aboutOverlay: "absolute inset-0 bg-linear-to-t from-[#dc2626]/30 to-transparent",
  aboutCaption: "absolute bottom-0 left-0 right-0 p-8 bg-linear-to-t from-[#b91c1c]/80 to-transparent",
  ...
  aboutHeading: "text-5xl font-black bg-linear-to-r from-[#dc2626] to-[#b91c1c] bg-clip-text text-transparent",
  aboutParagraph: "text-lg text-gray-700 leading-relaxed",
  aboutBoxGrid: "grid grid-cols-1 md:grid-cols-2 gap-6",
  aboutBox: "p-6 bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl border border-[#dc2626]/10",
  aboutBoxHeading: "text-2xl font-bold text-[#b91c1c] mb-3",
  aboutBoxText: "text-gray-600",

  teamSection: "py-20 bg-linear-to-br from-[#dc2626]/5 to-[#fca5a5]/5",
  sectionTitle: "text-5xl font-black bg-linear-to-r from-[#dc2626] to-[#b91c1c] bg-clip-text text-transparent",
  sectionUnderline: "mt-6 h-1 w-24 mx-auto bg-linear-to-r from-[#dc2626] to-[#fca5a5] rounded-full",
  teamCard: "group relative bg-white/95 backdrop-blur-lg rounded-[2rem] p-6 shadow-2xl border border-[#dc2626]/10 transition-transform hover:-translate-y-3",
  ...
  teamOverlay: "absolute inset-0 bg-linear-to-t from-[#dc2626]/40 to-transparent",
  teamName: "text-2xl font-bold text-gray-900 mb-1",
  teamPosition: "text-lg text-[#dc2626] font-medium mb-6",
  socialIcon: "p-2 rounded-full bg-linear-to-r from-[#dc2626] to-[#fca5a5] text-white hover:shadow-lg transition-all hover:scale-110",

  branchSection: "py-20",
  branchCard: "bg-white/95 backdrop-blur-lg rounded-2xl p-6 shadow-2xl border border-[#dc2626]/10 transition-transform hover:-translate-y-2",
  ...
  branchOverlay: "absolute inset-0 bg-linear-to-t from-[#dc2626]/30 to-transparent",
  branchInfoWrapper: "space-y-4",
  branchLocationWrapper: "flex items-center space-x-3",
  branchLocation: "text-xl font-semibold text-[#b91c1c]",
