...
import { AlertCircle, Check, CheckCircle, Mail, MapPin, MessageSquare, Phone, Send, User } from 'lucide-react'
        ...
        <div className=' container mx-auto px-4 md:px-6'>
            <div className={styles.headerStyle}>
                ...
                <p className='text-gray-600 max-w-2xl mx-auto'>
                  For any queries, feedback, or selling own book? Feel free to contact us.
                </p>

            </div>
            <div className=' grid grid-cols-1 lg:grid-cols-3 gap-8'>
              <div className={styles.contactInfoCardStyle}>
                <h2 className={styles.sectionHeadingStyle}>Contact Info ☎</h2>
                <div className='space-y-6'>
                  <div className={styles.contactItemStyle}>
                    ...
                    <div>
                      ...
                      <p className='text-gray-800'>Malout, near Bus-stand, 152107, Punjab</p>
                    </div>
                  </div>
                  ...
                  <div className={styles.contactItemStyle}>
                    ...
                    <div>
                      ...
                      <p className='text-gray-800'>Contact@bookstory.com</p>
                    </div>
                  </div>
                  ...
                  <div className={styles.contactItemStyle}>
                    ...
                    <div>
                      <h3 className=' font-medium text-gray-800 mb-1'>Our Contact Number</h3>
                      <p className='text-gray-800'>+91 0123456789</p>
                    </div>
              ...
              <div className={styles.contactFormCardStyle}>
                <h2 className={styles.sectionHeadingStyle}>Feel free to contact us though whatsapp</h2>
