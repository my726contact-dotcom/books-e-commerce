...
import { ArrowRight, BookOpen, Minus, Plus, ShoppingBag, Trash2 } from 'lucide-react'
...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    .then(({data}) => {
      ...
      console.log('image keys map:', Object.keys(map))
      setImages(map);
    })
      ...
      <div className={styles.wrapper}>
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            {cart.items.length} Item{cart.items.length !== 1 && 's'} In The Cart
        ...
        {cart.items.length === 0 ? (
          <div className={styles.emptyCard}>
            ...
            <h2 className={styles.emptyTitle}>Looks like your cart is empty</h2>
            <p className={styles.emptyDescription}>
              Search Stories that you find attractive and start reading for your children's
            </p>
          ...
          <div className={styles.cartGrid}>
            ...
            <div className={styles.summaryCard}>
              <h2 className={styles.summaryTitle}>Your Order Summary ♥</h2>
              <div className={styles.summaryBreakdown}>
                <div className={styles.summaryRow}>
                  <span className={styles.summaryLabel}>
                    Your Subtotal is ({cart.items.length} items)
                  </span>
                ...
                <div className={styles.summaryRow}>
                  ...
                  <span className={styles.summaryValue}>Calculated during Checkout</span>
