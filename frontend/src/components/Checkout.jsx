...
import { ArrowLeft, CheckCircle, CreditCard, DollarSign, FireExtinguisher, MapPin, ShoppingCart } from 'lucide-react'
      ...
      <div className=' min-h-screen bg-linear-to-br from-[#43C6AC] to-[#F8FFAE] py-20'>
        <div className='container mx-auto px-4 max-w-4xl'>
          <div className='bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center'>
            ...
            <h1 className='text-3xl md:text-4xl font-bold bg-linear-to-r from-[#1A237E] to-[#43C6AC] bg-clip-text
             text-transparent mb-4'>
              Your Ordered is Confirmed!
            </h1>
            <p className='text-gray-600 text-lg mb-8'>
               Thanks for buying, Your Order has been Placed successfully•••
            </p>

            <div className='bg-linear-to-r from-[#43C6AC]/10 to-[#F8FFAE]/10 rounded-xl p-6 mb-8 max-w-lg
            mx-auto'>
            ...
            <p className='text-gray-600'>
              We've sent a cofirmation email to <span className='font-medium'>{formData.email}</span>.
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link to='/books' className='px-6 py-3 bg-linear-to-r from-[#1A237E] to-[#43C6AC] text-white
              rounded-lg font-medium hover:opacity-90 '>
                Continue Shopping              
              </Link>
              <Link to='/orders' className='px-6 py-3 bg-white border-[#43C6AC] text-[#43C6AC] rounded-lg
              font-medium hover:bg-[#43C6AC]/10'>
                View order details
              </Link>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className='mb-6'>
                ...
                {formFields.map((row, rowIndex) => (
                  <div 
                  key={rowIndex} 
                  className={`grid grid-cols-1 ${row.some(
                    ...
                    {row.map(field => (
                      <div key={field.name} className={field.fullWidth ? 'col-span-full' : ''}>
                        <label className='block text-gray-700 mb-2'>
                          ...
                          onChange={handleChange} className='w-full px-4 py-3 border border-gray-300
                          rounded-lg focus:ring-2 focus:ring-[#43C6AC] focus:border-transparent'
              ...
              <div className='mb-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'> 
                  {paymentMethods.map(method => (
                    <div key={method.id}>
                      <input type="radio"
                      id={method.id} name='paymentMethod' value={method.id}
                      ...
                      className={` block p-4 border-2 rounded-lg cursor-pointer ${
                        ...
                        <div className='flex items-center'>
                          ...
                          <div className='flex items-center'>
                            ...
                            <span className='block text-sm text-gra-600'>
                              {method.description}
                            </span>
                          </div>
                        </div>
              ...
              <button type='submit' className='w-full py-4 bg-linear-to-r from-[#1A237E] to-[#43C6AC] text-white
