...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setToast({ visible: true, message: 'Creating Your Account...', tpe: 'info' });
    ...
    <div className={Signup.container}>
        ...
        <div className={Signup.card}>
            ...
            <div className=' text-center mb-8'>
                ...
                <p className={Signup.subtext}>Welcome, Join our Book website</p>

            </div>

            <form onSubmit={handleSubmit} className={Signup.form}>
                <div>
                  <label className={Signup.label}>YourName</label>
                 ...
                 <div>
                  <label className={Signup.label}>YourEmail</label>
                  <div className={Signup.inputWrapper}>
                 ...
                 <button type='submit' className={Signup.submitBtn}>Create Account</button>
